...
#ifndef PAIRSHOT_SWIFT_H
#define PAIRSHOT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PairShot",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <ul>
///   <li>
///     모든 AVFoundation 설정·변경은 <code>sessionQueue</code>(serial background queue)에서 실행한다.
///   </li>
///   <li>
///     <code>@Observable</code> 프로퍼티 업데이트는 반드시 <code>@MainActor</code>로 전환한다.
///   </li>
///   <li>
///     권한 요청은 절대 init에서 하지 않는다 (just-in-time).
///   </li>
/// </ul>
SWIFT_CLASS("_TtC8PairShot13CameraManager")
...
@interface CameraManager (SWIFT_EXTENSION(PairShot)) <AVCapturePhotoCaptureDelegate>
- (void)captureOutput:(AVCapturePhotoOutput * _Nonnull)_ didFinishProcessingPhoto:(AVCapturePhoto * _Nonnull)photo error:(NSError * _Nullable)error;
@end

SWIFT_CLASS("_TtC8PairShot15LowLightManager")
@interface LowLightManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSCoder;
SWIFT_CLASS("_TtC8PairShot13PreviewUIView")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC8PairShot13SensorManager")
...
@class CLLocation;
@class CLHeading;
@interface SensorManager (SWIFT_EXTENSION(PairShot)) <CLLocationManagerDelegate>
