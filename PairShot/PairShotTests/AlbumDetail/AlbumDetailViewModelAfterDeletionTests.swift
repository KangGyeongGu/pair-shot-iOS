...
@MainActor
struct AlbumDetailViewModelAfterDeletionTests {
    @Test
    ...
    private static func makeViewModel() -> AlbumDetailViewModel {
        let suiteName = "album-detail-vm-after-delete-\(UUID().uuidString)"
        ...
        return env.makeAlbumDetailViewModel(albumId: UUID())
    }
