...
struct PhotoPairCountTests {
    ...
    @Test
    func `countCreated returns 0 on empty store`() async throws {
    ...
    @Test
    func `countCreated since today midnight excludes earlier days`() async throws {
        let repository = try makeRepository()
    ...
    @Test
    func `countCreated since future date returns 0`() async throws {
        let repository = try makeRepository()
