...
- Phase: **P8 종료 (P8.5 완료 — 쿠폰·AdFree 상태 섹션)**
- 다음 task: **Phase 9 — Polish**
- Branch: `feature/ios-mvp/p8c-coupon-adfree-status`
- Last commit: feat(P8c) 쿠폰·AdFree 상태 섹션 + Coupon 등록 wire-up
