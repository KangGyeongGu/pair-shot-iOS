...
- Phase: **P10 종료 (P10.4·P10.5·P10.6 + P9 reviewer advisory 흡수 완료)**
- 다음 task: **Phase 11 — App Store 출시** (사용자 수행 — roadmap 미정의, `docs/02-testflight-upload-guide.md` 가이드 참조)
- Branch: `feature/ios-mvp/p10b-checklist-release-polish`
- Last commit: feat(P10b) 디바이스 체크리스트 + Release config + view 다이어트 + TestFlight 안내
