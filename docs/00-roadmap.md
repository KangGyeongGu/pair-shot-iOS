...
- Phase: **P8a 종료 (Settings 골격 + 촬영 설정 — JPEG 품질·파일명 prefix)**
- 다음 task: **P8b — 합성 설정 + 저장 용량 (P8.3·P8.4)**
- Branch: `feature/ios-mvp/p8a-settings-capture`
- Last commit: feat(P8a) Settings 골격 + 촬영 설정 (JPEG 품질·파일명 prefix)
